...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-admin-panel-key-change-in-production')
...
ROOT_URLCONF = 'myunsejeomju.urls'
...
WSGI_APPLICATION = 'myunsejeomju.wsgi.application'
